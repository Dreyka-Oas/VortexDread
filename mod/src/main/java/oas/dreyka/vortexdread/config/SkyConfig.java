 ...
 *
 * <p>Every one of these has to hold the same value on the server and on every client connected to it.
 * Clients do not receive the cloud field, they replay the simulation from the same seed and the same
